...
func (mr *MockUserDeviceAPIServiceMockRecorder) CanRequestInstantOfferByTokenID(ctx, tokenID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserDeviceAPIServiceMockRecorder) GetUserDeviceByEthAddr(ctx, ethAddr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserDeviceAPIServiceMockRecorder) GetUserDeviceByTokenID(ctx, tokenID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockUserDeviceAPIService) GetUserDeviceOffersByTokenID(ctx context.Context, tokenID *big.Int, take int) (*models.DeviceOffer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserDeviceOffersByTokenID", ctx, tokenID, take)
	ret0, _ := ret[0].(*models.DeviceOffer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserDeviceAPIServiceMockRecorder) GetUserDeviceOffersByTokenID(ctx, tokenID, take interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserDeviceOffersByTokenID", reflect.TypeOf((*MockUserDeviceAPIService)(nil).GetUserDeviceOffersByTokenID), ctx, tokenID, take)
}
...
func (m *MockUserDeviceAPIService) GetUserDeviceValuationsByTokenID(ctx context.Context, tokenID *big.Int, countryCode string, take int) (*models.DeviceValuation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserDeviceValuationsByTokenID", ctx, tokenID, countryCode, take)
	ret0, _ := ret[0].(*models.DeviceValuation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserDeviceAPIServiceMockRecorder) GetUserDeviceValuationsByTokenID(ctx, tokenID, countryCode, take interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserDeviceValuationsByTokenID", reflect.TypeOf((*MockUserDeviceAPIService)(nil).GetUserDeviceValuationsByTokenID), ctx, tokenID, countryCode, take)
}
...
func (mr *MockUserDeviceAPIServiceMockRecorder) LastRequestDidGiveErrorByTokenID(ctx, tokenID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
