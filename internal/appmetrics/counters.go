...
var (
	GRPCRequestCount = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "valuations_api_grpc_request_count",
	...
	GRPCResponseTime = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "valuations_api_grpc_response_time",
	...
	HTTPRequestCount = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "valuations_api_http_request_count",
	...
	HTTPResponseTime = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "valuations_api_http_response_time",
