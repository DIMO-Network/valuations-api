...
var ValuationWhere = struct {
	...
	VinMetadata:        whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"vin_metadata\""},
	OfferMetadata:      whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"offer_metadata\""},
	AutocheckMetadata:  whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"autocheck_metadata\""},
	BuildMetadata:      whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"build_metadata\""},
	CargurusMetadata:   whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"cargurus_metadata\""},
	CarvanaMetadata:    whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"carvana_metadata\""},
	CarmaxMetadata:     whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"carmax_metadata\""},
	CarstoryMetadata:   whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"carstory_metadata\""},
	EdmundsMetadata:    whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"edmunds_metadata\""},
	TMVMetadata:        whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"tmv_metadata\""},
	KBBMetadata:        whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"kbb_metadata\""},
	VroomMetadata:      whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"vroom_metadata\""},
	...
	PricingMetadata:    whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"pricing_metadata\""},
	BlackbookMetadata:  whereHelpernull_JSON{field: "\"valuations_api\".\"valuations\".\"blackbook_metadata\""},
...
var (
	valuationAllColumns            = []string{"id", "device_definition_id", "vin", "user_device_id", "vin_metadata", "offer_metadata", "autocheck_metadata", "build_metadata", "cargurus_metadata", "carvana_metadata", "carmax_metadata", "carstory_metadata", "edmunds_metadata", "tmv_metadata", "kbb_metadata", "vroom_metadata", "created_at", "updated_at", "pricing_metadata", "blackbook_metadata", "request_metadata", "vincario_metadata"}
	valuationColumnsWithoutDefault = []string{"id", "vin"}
	valuationColumnsWithDefault    = []string{"device_definition_id", "user_device_id", "vin_metadata", "offer_metadata", "autocheck_metadata", "build_metadata", "cargurus_metadata", "carvana_metadata", "carmax_metadata", "carstory_metadata", "edmunds_metadata", "tmv_metadata", "kbb_metadata", "vroom_metadata", "created_at", "updated_at", "pricing_metadata", "blackbook_metadata", "request_metadata", "vincario_metadata"}
