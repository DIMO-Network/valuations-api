...
var (
	valuationAllColumns            = []string{"id", "device_definition_id", "vin", "user_device_id", "offer_metadata", "edmunds_metadata", "created_at", "updated_at", "drivly_pricing_metadata", "request_metadata", "vincario_metadata"}
	valuationColumnsWithoutDefault = []string{"id", "vin"}
	valuationColumnsWithDefault    = []string{"device_definition_id", "user_device_id", "offer_metadata", "edmunds_metadata", "created_at", "updated_at", "drivly_pricing_metadata", "request_metadata", "vincario_metadata"}
