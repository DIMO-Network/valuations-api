// Package docs Code generated by swaggo/swag at 2024-03-23 07:55:55.870318 -0400 EDT m=+4.472999168. DO NOT EDIT
package docs
...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/user/devices/{userDeviceID}/instant-offer": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "userDeviceID for vehicle to get offers",
                        "name": "userDeviceID",
                        "in": "path",
                        "required": true
                    }
        ...
        "/vehicles/{tokenId}/instant-offer": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
