// Package docs Code generated by swaggo/swag at 2024-04-19 15:40:00.736438 -0400 EDT m=+1.328499084. DO NOT EDIT
package docs
...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/v1/user/devices/{userDeviceID}/instant-offer": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/user/devices/{userDeviceID}/offers": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/user/devices/{userDeviceID}/valuations": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
